...
class _HomePageState extends ConsumerState<MemberManagementPage> {
  ...
  MemberSortType selectedSortType = MemberSortType.name;
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((Duration _) async {
      try {
        ...
        ref.read(memberControllerProvider.notifier).setSort(selectedSortType, selectedSortDirection);
      } catch (e) {
        if (mounted) {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: _isLoading
          ...
          members.isEmpty ? const Center(child: Text('No data found.'))
          : LayoutBuilder(
                          ...
                          children: <Widget>[
                            ...
                            DropdownButton<SortDirection>(
                              ...
                              onChanged: (SortDirection? value) {
                                if (value != null) {
                                  setState(() => selectedSortDirection = value);
                                  ref.read(memberControllerProvider.notifier).setSort(selectedSortType, selectedSortDirection);
                                  FocusScope.of(context).requestFocus(FocusNode());
                                }
                              },
                          ...
                          children: <Widget>[
                            ...
                            DropdownButton<SortDirection>(
                              ...
                              items: SortDirection.values.map((SortDirection dir) {
                                ...
                                return DropdownMenuItem<SortDirection>(value: dir, child: Padding(
